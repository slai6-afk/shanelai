...
export function TalkieCaseStudy() {
  ...
  return (
    <div className="case-study-page case-study-page--talkie min-h-screen bg-[var(--ds-bg-page)]">
      <Navigation />
      <section className="case-study-hero-section pt-24 sm:pt-32 md:pt-40 pb-4 sm:pb-5 md:pb-6 px-4 sm:px-6 md:px-8 lg:px-16">
        <div className="max-w-[1200px] mx-auto">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <h1 style={{ color: '#000000', fontSize: 'var(--ds-text-display)', fontWeight: 400, lineHeight: '1.2', marginBottom: '16px' }}>Talkie</h1>
            <p style={{ color: '#666666', fontSize: 'var(--type-l4)', fontWeight: 400, lineHeight: '1.6', marginBottom: '32px', maxWidth: '800px' }}>
              AI voice companion for truck drivers designed through{' '}
              <WordBackdropDecor vector="highlight3">empathy-driven</WordBackdropDecor> research
            </p>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', marginBottom: '24px' }}>
              <span style={{ padding: '8px 16px', backgroundColor: '#1D0024', color: '#FFFFFF', fontSize: 'var(--type-l1)', fontWeight: 500, textTransform: 'uppercase' }}>Research</span>
              <span style={{ padding: '8px 16px', backgroundColor: '#FFFFFF', color: '#000000', fontSize: 'var(--type-l1)', fontWeight: 500, border: '1px solid rgba(0, 0, 0, 0.2)' }}>AI · Voice · Ethnographic Research</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-4 lg:gap-4">
            ...
            <div className="case-study-content-wrapper w-full max-w-none min-w-0 flex flex-col">
              ...
              <div id="background" style={{ marginBottom: '80px' }}>
                <motion.h2 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} style={{ color: '#000000', fontSize: 'var(--type-l5)', fontWeight: 400, marginBottom: '24px' }}>Research Context</motion.h2>
                <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} style={{ color: '#666666', fontSize: 'var(--type-l3)', fontWeight: 400, lineHeight: '1.8' }}>
              ...
              <div id="findings" style={{ marginBottom: '80px' }}>
                <motion.h2 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} style={{ color: '#000000', fontSize: 'var(--type-l5)', fontWeight: 400, marginBottom: '32px' }}>Key Insights</motion.h2>
              ...
              <div id="credits" style={{ marginBottom: '40px' }}>
                <motion.h2 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} style={{ color: '#000000', fontSize: 'var(--type-l5)', fontWeight: 400, marginBottom: '24px' }}>Credits & Ethics</motion.h2>
                <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} style={{ backgroundColor: '#FFFFFF', border: '1px solid rgba(0, 0, 0, 0.08)', padding: '32px' }}>
                  <p style={{ color: '#666666', fontSize: 'var(--type-l3)', lineHeight: '1.8', marginBottom: '16px' }}><strong style={{ color: '#000000' }}>Team:</strong> Shane Lai (Lead Researcher), UX Research Team at Minimax</p>
                  <p style={{ color: '#666666', fontSize: 'var(--type-l3)', lineHeight: '1.8', margin: 0 }}><strong style={{ color: '#000000' }}>Ethics:</strong> All participants provided informed consent. Data anonymized. $100 compensation per session. Research approved by company ethics review.</p>
                </motion.div>
              </div>
            </div>
          </div>
